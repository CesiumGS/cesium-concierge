...
| `repositories:{name}:checkChangesMd` | `string` | If `"true"`, check if `CHANGES.md` has been updated in pull request. If not, post comment suggesting that it should be edited. | X
