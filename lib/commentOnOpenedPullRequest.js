...
var claMessage = 'Please follow the instructions [here](https://github.com/AnalyticalGraphicsInc/cesium/blob/master/CONTRIBUTING.md#contributor-license-agreement-cla) ' +
    'to add yourself to the Contributor License Agreement.\n\n';
 ...
 */
function commentOnOpenedPullRequest(jsonResponse, headers, thirdPartyFolders, checkChangesMd, claJson) {
    ...
    return commentOnOpenedPullRequest._implementation(pullRequest.url + '/files', pullRequest.comments_url,
        headers, thirdPartyFolders, checkChangesMd, claJson, pullRequest.user.login);
}
...
commentOnOpenedPullRequest._implementation = function (pullRequestFilesUrl, pullRequestCommentsUrl, headers,
                                                       thirdPartyFolders, checkChangesMd, claJson, username) {
